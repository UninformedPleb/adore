...
namespace ADORE
{
	public class QueryParameter
	{
		...
		public static DbType GetDbTypeMappingFrom(object o)
		{
			return GetDbTypeMapping(o.GetType());
		}
		public static DbType GetDbTypeMapping(Type t)
		{
			return TypeMapSpec.FindByCSharpType(t).FirstOrDefault()?.DbType ?? DbType.Object;
		}
		#endregion
		...
		/// <para>This is non-destructive. The Name remains unchanged.</para>
		/// </summary>
		public string PropertyizedName
		{
			get
			{
